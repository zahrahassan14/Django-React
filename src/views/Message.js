                                    ...
                                    <div className="chat-messages p-4">
                                        ...
                                        <div className="chat-message-left pb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                ...
                                                Hey Bob! It's going well, thanks. How about yours?
                                            </div>
                                        </div>
                                        <div className="chat-message-right mb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                <div className="font-weight-bold mb-1">You</div>
                                                Same here, busy as always. Did you get a chance to check the latest project updates?
                                            </div>
                                        </div>
                                        <div className="chat-message-left pb-4">
                                            <div>
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                <div className="font-weight-bold mb-1">Sharon Lessman</div>
                                                Not yet, I've been stuck in meetings all morning.
                                            </div>
                                        </div>
                                        <div className="chat-message-left pb-4">
                                            <div>
                                        ...
                                        <div className="chat-message-right mb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                <div className="font-weight-bold mb-1">You</div>
                                                Yeah, the client sent some feedback. We might need to make a few adjustments before the deadline.
                                        ...
                                        <div className="chat-message-left pb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                <div className="font-weight-bold mb-1">Sharon Lessman</div>
                                                Got it. I'll dive into it after lunch. By the way, did you see the email about the team-building event next week?
                                        ...
                                        <div className="chat-message-right mb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                <div className="font-weight-bold mb-1">You</div>
                                                Yeah, I did. Bowling, right? Should be fun!
                                            </div>
                                        </div>
                                        <div className="chat-message-right mb-4">
                                            <div>
                                        ...
                                        <div className="chat-message-left pb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                <div className="font-weight-bold mb-1">Sharon Lessman</div>
                                                Absolutely! It's been a while since we had some team bonding. Count me in.
                                            </div>
                                        </div>
                                        <div className="chat-message-right mb-4">
                                            <div>
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 mr-3">
                                                <div className="font-weight-bold mb-1">You</div>
                                                Great! Looking forward to it. And hey, if you need help with the project adjustments, just let me know.
                                        ...
                                        <div className="chat-message-left pb-4">
                                            ...
                                            <div className="flex-shrink-1 bg-light rounded py-2 px-3 ml-3">
                                                <div className="font-weight-bold mb-1">Sharon Lessman</div>
                                                Thanks, Bob! I might take you up on that offer. Appreciate it.
